  ...
  Application:       mod_authn_ntml 1.0.8 for Apache 2.4.x x64
  Distribution File: mod_authn_ntml-1.0.8-2.4.x-x64-vc15.zip
  ...
  Windows Server 2008/2012/2016/2019 x64 only
  ...
  new Visual C++ 2017 x64 Redistributable Package, download from;
  ...
  Install the Visual C++ 2017 x64 Redistributable Package 
