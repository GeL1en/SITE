  ...
  Application:       Mod Antiloris 0.6.0 x64
  Distribution File: mod_antiloris-0.6.0-2.4.x-vc15-x64.zip 
  ...
  ** This build for Apache 2.4.x x64 only! **
  ...
  Supported Windows x64 Versions:
  Windows Vista/7/8/8.1/10 x64
  Windows Server 2008/2012 x64
  Windows Home Server 2011 x64

 NOTES:

  Modules built on Visual C++ 2017 do not run on Windows XP or Windows Server 2003

  The module is built with Visual Studio® 2017 x64, be sure to install the 
  new Visual C++ 2017 x86 Redistributable Package, download from;
  ...
  # will allow 10 open connections in each state for a total of 30
